...
//
// `persist` ke AsyncStorage: daftar laporan terakhir tersimpan offline, jadi
// saat app dibuka tanpa koneksi, feed lama masih tampil sampai fetch berhasil.
